...
import { Copy, Send, LogOut, Eye, EyeOff, X, CheckCircle, Download, Wallet } from 'lucide-react';
            ...
            <div className="bg-gray-900 shadow-sm border-b border-gray-800">
                <div className="max-w-6xl mx-auto px-4 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-3">
                        <div className="w-8 h-8 bg-gradient-to-r from-blue-600 to-blue-800 rounded-lg flex justify-center align-center items-center "><Wallet className="w-5 h-5 text-white" /></div>
